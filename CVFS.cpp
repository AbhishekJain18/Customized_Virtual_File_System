...
void man(char *name)
{
    ...
    {
        printf("Discription : Used to remove all the data form file\n");
...
//    Input parameters  :    -                //
//    Return value      : void                //
//    Description       : Display command and //
//              and their functionallity      //
//                                            //
////////////////////////////////////////////////
void DisplayHelp()
{
    printf("ls : To list out all the files\n");
    printf("clear : To creat the console\n");
...
//------------------FUNCTION------------------//
//                                            //
//    Name of function  : char * name         //
//    Input parameters  : GetFDFromName       //
//    Return value      : int                 //
//    Description       : return File's       //
...
//    Input parameters  :  char *name         //
//    Return value      :  PINODE             //
//    Description       :  Travalsal of inode //
//            LL till filename                //
//                                            //
////////////////////////////////////////////////
...
//------------------FUNCTION------------------//
//                                            //
//    Name of function  : IntialiseSuperBLock //
//    Input parameters  :     -               //
//    Return value      : void                //
//    Description       : Intializing the     //
//             variables prestent in struct   //
//             SuperBlock with MACRO          //
////////////////////////////////////////////////
...
//                        int permission      //
//    Return value      : int                 //
//    Description       : Creating file with  //
//              permissions, and user defined //
//              name to file                  //
////////////////////////////////////////////////
...
//    Input parameters  : int fd, char *arr,  //
//                        int isize           //
//    Return value      : int                 //
//    Description       : Read the data from  //
//               specified file               //
//                                            //
////////////////////////////////////////////////
...
//                        int isize           //
//    Return value      : int                 //
//    Description       : It copy(write) data //
//             into specified file            //
//                                            //
////////////////////////////////////////////////
...
//    Input parameters  :  char *name          //
//    Return value      :  int                 //
//    Description       :  close only that file//
//              that user want to close        //
//                                             //
/////////////////////////////////////////////////
...
//    Input parameters  : int fd, int size,   //
//                        int from            //
//    Return value      : int                 //
//    Description       :                     //
//                                            //
...
//    Input parameters  :    -                 //
//    Return value      :  void                //
//    Description       :  Listing down all the//
//                files present in that dir    //
//                                             //
/////////////////////////////////////////////////
void Ls_File()
{
    int i = 0;
    PINODE temp = head;
    if(SUPERBLOCKSobj.FreeInodes == MAXINODE)
    {
        printf("ERROR : There are no file\n");
        return;
    }
    printf("\nname\tInode number\tFile size\tLink count\n");
    printf("---------------------------------------------------\n");
    while(temp != NULL)
    {
        if(temp->FileType != 0)
...
//    Return value      :  int                //
//    Description       :  This function gives//
